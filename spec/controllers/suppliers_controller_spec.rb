  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved supplier as @supplier" do
        ...
        post :create, {:supplier => { "description" => "invalid value" }}, valid_session
        assigns(:supplier).should be_a_new(Supplier)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested supplier" do
        ...
        Supplier.any_instance.should_receive(:update_attributes).with({ "description" => "MyString" })
        put :update, {:id => supplier.to_param, :supplier => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the supplier as @supplier" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Supplier.any_instance.stub(:save).and_return(false)
        put :update, {:id => supplier.to_param, :supplier => { "description" => "invalid value" }}, valid_session
        assigns(:supplier).should eq(supplier)
      end
