...
describe DevicesController do
  ...
  let(:valid_attributes) { { "device_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved device as @device" do
        ...
        post :create, {:device => { "device_name" => "invalid value" }}, valid_session
        assigns(:device).should be_a_new(Device)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested device" do
        ...
        Device.any_instance.should_receive(:update_attributes).with({ "device_name" => "MyString" })
        put :update, {:id => device.to_param, :device => { "device_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the device as @device" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Device.any_instance.stub(:save).and_return(false)
        put :update, {:id => device.to_param, :device => { "device_name" => "invalid value" }}, valid_session
        assigns(:device).should eq(device)
      end
