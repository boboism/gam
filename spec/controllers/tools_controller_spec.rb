...
describe ToolsController do
  ...
  let(:valid_attributes) { { "tool_type_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tool as @tool" do
        ...
        post :create, {:tool => { "tool_type_id" => "invalid value" }}, valid_session
        assigns(:tool).should be_a_new(Tool)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tool" do
        ...
        Tool.any_instance.should_receive(:update_attributes).with({ "tool_type_id" => "1" })
        put :update, {:id => tool.to_param, :tool => { "tool_type_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tool as @tool" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tool.any_instance.stub(:save).and_return(false)
        put :update, {:id => tool.to_param, :tool => { "tool_type_id" => "invalid value" }}, valid_session
        assigns(:tool).should eq(tool)
      end
