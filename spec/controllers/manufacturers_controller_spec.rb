  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved manufacturer as @manufacturer" do
        ...
        post :create, {:manufacturer => { "description" => "invalid value" }}, valid_session
        assigns(:manufacturer).should be_a_new(Manufacturer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested manufacturer" do
        ...
        Manufacturer.any_instance.should_receive(:update_attributes).with({ "description" => "MyString" })
        put :update, {:id => manufacturer.to_param, :manufacturer => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the manufacturer as @manufacturer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Manufacturer.any_instance.stub(:save).and_return(false)
        put :update, {:id => manufacturer.to_param, :manufacturer => { "description" => "invalid value" }}, valid_session
        assigns(:manufacturer).should eq(manufacturer)
      end
